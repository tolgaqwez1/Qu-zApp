  ...
  Widget build(BuildContext context) {
    ...
    final firstNameField = TextFormField(
        ...
        validator: (value) {
          ...
          if (!regex.hasMatch(value)) {
            return ("Geçerli isim girin(Min. 3 Karakter)");
          }
          return null;
        },
        onSaved: (value) {
    ...
    final passwordField = TextFormField(
        ...
        validator: (value) {
          ...
          if (!regex.hasMatch(value)) {
            return ("Geçerli Parola Girin (Min. 6 Karakter)");
          }
        },
        onSaved: (value) {
          firstNameEditingController.text = value!;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: Color(0xFF648DB7)),
          onPressed: () {
